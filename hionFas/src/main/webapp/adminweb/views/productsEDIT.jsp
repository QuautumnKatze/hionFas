					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-warning">
								...
								<!-- /.card-header -->
								<div class="card-body">
									<form id="FormCreate" action="AdminProductsEditServlet" method="post">
										<div class="row">
											<div class="col-sm-12">
												<!-- select -->
												<div class="form-group">
													<label>Phân loại danh mục: </label> <select name="cid"
														class="form-control">
														<c:set value="${requestScope.ProductDataToUpdate }" var="prod"/>
														<c:forEach items="${requestScope.PCategoryData }" var="cate">
														
															<c:choose>
																<c:when test="${cate.pCategoryID == prod.category.pCategoryID }">
																	<option value="${cate.pCategoryID }" selected="selected"> ${cate.pCategoryName }</option>
																</c:when>
																<c:otherwise>
											...
											<div class="col-sm-12">
												...
												<div class="form-group">
													<label>Tên Sản Phẩm: </label> <input type="text"
														class="form-control" placeholder="Enter ..." name="name" value="${prod.productName }">
												</div>
												...
												<div class="form-group">
													...
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="image" name="image" value="${prod.image }">
												...
												<div class="form-group">
													...
													<textarea class="form-control" rows="3"
														placeholder="Enter ..." name="shortDes">${prod.shortDes }</textarea>
												</div>

												<div class="form-group">
													<label>Mô tả chi tiết sản phẩm: </label>
													<textarea class="form-control" rows="5" name="des" id="editor">${prod.description }</textarea>
												</div>


												<div class="form-group">
													<label>Giá Sản Phẩm: </label> <input type="number"
														class="form-control" placeholder="Enter ..." name="price" value="${prod.price }">
												</div>

												<div class="form-group">
													<label>Trọng lượng: </label> <input type="text"
														class="form-control" placeholder="Enter ..." name="weight" value="${prod.weight }">
												</div>

												<div class="form-group">
													<label>Vật liệu: </label> <input type="text"
														class="form-control" placeholder="Enter ..."
														name="material" value="${prod.material }">
												</div>

												<div class="form-group">
													<label>Xuất xứ: </label> <input type="text"
														class="form-control" placeholder="Enter ..." name="origin" value="${prod.origin }">
												</div>

												<div class="form-group">
													<label>Kích thước: </label> <input type="text"
														class="form-control" placeholder="Enter ..."
														name="dimension" value="${prod.dimension }">
												</div>

												<div class="form-group">
													<div class="form-check">
														<c:if test="${prod.isActive() == true }">
															<input class="form-check-input" type="checkbox" name="isActive" checked="checked"> 
														</c:if>
													...
													<div class="form-check">
														<c:if test="${prod.isNew() == true }">
															<input class="form-check-input" type="checkbox" name="isNew" checked="checked"> 
														</c:if>
													...
													<div class="form-check">
														<c:if test="${prod.isBestSeller() == true }">
															<input class="form-check-input" type="checkbox" name="isBestSeller" checked="checked"> 
														</c:if>
